...
void MainWindow::on_pb_instagram_2_clicked()
{
   QString link="https://esprit-tn.com/esponline/online/default.aspx";
   QDesktopServices::openUrl(QUrl(link));
}

void MainWindow::on_pb_facebook_2_clicked()
{
    QString link="https://esprit-tn.com/esponline/online/default.aspx";
    QDesktopServices::openUrl(QUrl(link));
}
...
void MainWindow::on_but_modifier_clicked()
{
...
void MainWindow::on_but_img_clicked()
{
...
void MainWindow::on_tab_bus_clicked(const QModelIndex &index)
{
...
void MainWindow::on_but_img2_clicked()
{
    QString fileNames = QFileDialog::getOpenFileName(this, tr("Open File"),"/path/to/file/");
    ui->img->setText(fileNames);
}
