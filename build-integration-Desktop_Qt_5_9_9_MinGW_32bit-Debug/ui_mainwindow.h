...
public:
    ...
    QTextBrowser *roomTextEdit;
    QPushButton *chat_2;
    QTextBrowser *roomTextEdit_2;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        chatt = new QGroupBox(tab);
        chatt->setObjectName(QStringLiteral("chatt"));
        chatt->setGeometry(QRect(100, 380, 591, 331));
        stackedWidget = new QStackedWidget(chatt);
        stackedWidget->setObjectName(QStringLiteral("stackedWidget"));
        stackedWidget->setGeometry(QRect(10, 20, 571, 311));
        page = new QWidget();
        page->setObjectName(QStringLiteral("page"));
        sayLineEdit = new QLineEdit(page);
        sayLineEdit->setObjectName(QStringLiteral("sayLineEdit"));
        sayLineEdit->setGeometry(QRect(10, 20, 261, 24));
        roomTextEdit = new QTextBrowser(page);
        roomTextEdit->setObjectName(QStringLiteral("roomTextEdit"));
        roomTextEdit->setGeometry(QRect(20, 60, 256, 192));
        chat_2 = new QPushButton(page);
        chat_2->setObjectName(QStringLiteral("chat_2"));
        chat_2->setGeometry(QRect(270, 280, 75, 23));
        roomTextEdit_2 = new QTextBrowser(page);
        roomTextEdit_2->setObjectName(QStringLiteral("roomTextEdit_2"));
        roomTextEdit_2->setGeometry(QRect(310, 60, 256, 192));
        sayLineEdit_2 = new QLineEdit(page);
        sayLineEdit_2->setObjectName(QStringLiteral("sayLineEdit_2"));
        sayLineEdit_2->setGeometry(QRect(300, 20, 261, 24));
        ...
        menuBar->setGeometry(QRect(0, 0, 1005, 26));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        chatt->setTitle(QApplication::translate("MainWindow", "CHAT", Q_NULLPTR));
        chat_2->setText(QApplication::translate("MainWindow", "chat", Q_NULLPTR));
